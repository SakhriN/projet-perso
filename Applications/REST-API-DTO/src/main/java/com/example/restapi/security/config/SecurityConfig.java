...
import com.example.restapi.security.jwt.JwtAuthenticationEntryPoint;
import com.example.restapi.security.jwt.JwtRequestFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(UsersService usersService, JwtAuthenticationEntryPoint jwtAuthenticationEntryPoint) {
...
// Construire et retourner la chaîne de filtres de sécurité configurée.
    ...
    public JwtRequestFilter jwtAuthenticationFilter() {
        ...
        return new JwtRequestFilter(usersService);
    }
